...
var MentionSuggestions = function (_Component) {
  ...
  function MentionSuggestions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MentionSuggestions.__proto__ || Object.getPrototypeOf(MentionSuggestions)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var updated_mention = void 0;
      if (_this.props.onAddMention) {
        updated_mention = _this.props.onAddMention(mention);
      }

      _this.closeDropdown();
      var newEditorState = (0, _addMention2.default)(_this.props.store.getEditorState(), updated_mention || mention, _this.props.mentionPrefix, _this.props.mentionTrigger, _this.props.entityMutability);
